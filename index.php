...
body {
    background: -webkit-linear-gradient(left, #051b79, #188ed1);
                    ...
                    <div class="col-md-9 register-right" style="margin-top: 40px;left: 80px;">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                              ...
                              <!--  <form method="post" action="func2.php"> -->   <form method="post" action="func.php">
                                <div class="row register-form">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <a href="add.php" class="he"> Registere here?</a>
                            ...
                            <div class="tab-pane fade show" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                ...
                                <div class="row register-form">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Email *" name="demail" required/>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
